...
const ExchangePocket = (props) => {
  const { type, allCurrencies, currencyExchange, pocketsPair, onInputChange, onSelectCurrency, setTransactionDetails } = props;
    ...
    <section className={`app-exchange_pocket ${type}`}>
      <div className="app-exchange_currency-container">
        ...
        <div className="app-exchange_amount-input">
          <input type="number" placeholder={0.00} ref={currentCurrencyInput} onChange={onInputCurrency} step=".01" />
        </div>
      </div>
